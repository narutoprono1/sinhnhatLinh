...
const SOUNDS = {
  ...
  MATCH: new Audio('match-strike-trimmed.mp3'),

  TUNE: new Audio('happy-birthday-trimmed.mp3'),

  ON: new Audio('switch-on.mp3'),
  
  BLOW: new Audio('blow-out.mp3'),

  POP: new Audio('pop-trimmed.mp3'),
